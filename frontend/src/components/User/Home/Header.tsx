    ...
    <header className="sticky top-0 bg-white shadow-sm z-50 border-b border-[#e8e2d9]">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <nav className="flex justify-between items-center">
          <button onClick={() => navigate('/')} className="flex items-center space-x-2 text-2xl font-semibold tracking-wide text-[#2c2420] hover:text-[#8b5d3b] transition-colors">
          ...
          <div className="flex items-center space-x-8">
            <button onClick={() => navigate('/')} className="text-sm text-[#2c2420] hover:text-[#8b5d3b] transition-colors">Home</button>
            <button onClick={() => navigate('/menu')} className="text-sm text-[#2c2420] hover:text-[#8b5d3b] transition-colors">Menu</button>
            <button onClick={() => navigate('/restaurentList')} className="text-sm text-[#2c2420] hover:text-[#8b5d3b] transition-colors">Restaurants</button>
...
>
  ...
  Profile
              ...
              <div className="flex items-center space-x-4">
                <button onClick={() => navigate('/signup')} className="text-sm text-[#8b5d3b] hover:bg-[#2c2420] hover:text-[#faf7f2] py-2 px-4 rounded transition-colors">
                  Register
                </button>
                <button
